workspace "HDBEEFUPWorkspace"
   ...
   defines { "rsc_CompanyName=\"hdbeefup\"" }
   defines { "rsc_LegalCopyright=\"hdbeefup\""}
...
project "HDB.MicroCommandos"
   setpaths("Z:/Games/hdbeefup/scripts", "hdbeefup.exe")
